...
import 'package:integradora/controller/ejercicioSeleccionadoBraille.dart';
import 'package:integradora/controller/obtenerNivelesBraille.dart';
import 'package:integradora/view/nivel.dart';

class Braille extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<Nivel>>(
        future: obtenerNivelesBraille(), // Llama a la función que obtiene los datos
                    ...
                    ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => NivelDetalleBraille(nivelData: nivel.id),
                          ),
                        );
                      },
                    ),
